...
<div id="helpModal" class="modal hide">
    ...
    <div class="modal-body">
        ...
        <div id="content_help">
            ...
            <p>
                Esta seção informa os <span class="label label-info">4 processos mais recentes</span> onde que este advogado atua. 
                Se o ele for um <span class="label label-info">User</span> significa que ele é um funcionário da advocacia.
                <br />
