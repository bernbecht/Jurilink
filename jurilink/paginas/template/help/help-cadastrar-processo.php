    ...
    <div class="modal-body">
        ...
        <div id="content_help">
            <div class="page-header">
                <h1>Cadastrar Processo<button id="ativa_video_help_btn" class="btn btn-info pull-right voltarTextoHelpBtn"><i class="icon-play-circle icon-white"></i> Vídeo</button></h1>
            </div>
            <p>
                Nesta tela é possível <span class="label label-info">cadastrar</span> um ou mais <span class="label label-info">Processos</span>
                no sistema.
            </p>
            <div class="page-header">
            ...
            <p>
                Para cadastrar um novo processo é necessário preencher pelo menos os campos obrigatórios indicicados pela cor
                amarela.
            ...
            <dl>
                <dt>Salvar</dt>
                <dd>Adiciona o processo ao sistema e retorna à tela com a relação dos processos cadastrados no
                    sistema.</dd>
                <dt>Salvar e Adicionar Outro</dt>
                <dd>Adiciona o processo e limpa o formulário para que se possa adicionar outro.</dd>
                <dt>Cancelar</dt>
                <dd>Cancela a operação e retorna à tela com a retorna à tela com a relação dos processos cadastrados no
                    sistema.</dd>            
            </dl>
        </div>
    </div>
