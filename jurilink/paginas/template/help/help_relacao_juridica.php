    ...
    <div class="modal-body">
        ...
        <div id="content_help">
            ...
            <div class="page-header">
                <h1>Pessoa Jurídica<button id="ativa_video_help_btn" class="btn btn-info pull-right voltarTextoHelpBtn"><i class="icon-play-circle icon-white"></i> Vídeo</button></h1>
            </div>
            <p>
                A tela <span class="label label-info">Pessoa Jurídica</span> lista
