    ...
    <div class="modal-body">
        ...
        <div id="content_help">
            <div class="page-header">
                <h1>Editar Advogado<button id="ativa_video_help_btn" class="btn btn-info pull-right voltarTextoHelpBtn"><i class="icon-play-circle icon-white"></i> Vídeo</button></h1>
            </div>
            <p>
                Nesta tela é possível editar os dados cadastrais de um <span class="label label-info">advogado</span>
            ...
            <p>
                Para editar um advogado é necessário preencher pelo menos os campos obrigatórios indicicados pela cor
                amarela.
