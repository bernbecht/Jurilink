        ...
        <div class="container"  >
            <div class="row show-grid">
				...
				<?php 
					...
					$result = pg_query($conexao, "SELECT nome, id_natureza_acao FROM natureza_acao");
                ...
                <div class="span6 drop">
                    <div class="drag">
									...
									echo "<table = 'teste' class=table table-striped table-condensed >";
										...
										while ($row = pg_fetch_row($result)) {
											echo "<tr>
													...
													<td>".$row[1]."</td>
													<td>
														<a class=btn btn-small btn-success href= '#' onClick='getIdNatureza_acao($row[1])'>
						...
						<form name = "formulario_natureza_acao_excluir" action="../operacoes/CNatureza_acao/excluir_natureza_acao_op.php" method="post">
							<input type="hidden" name="id_natureza_acao_excluir" value="-1">
						</form>
                    </div>
                </div>
