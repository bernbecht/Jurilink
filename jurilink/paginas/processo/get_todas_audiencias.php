...
if ($audiencia->local != '') {
    ...
    do {
        ...
        if ($_SESSION['tipo_usuario'] == 2)
            echo "<td class='centro'><a class='tooltip_class' rel='tooltip' data-placement='top' data-original-title='Excluir esta audiências' href=#><i class='icon-remove-circle excluir-audiencia'><input type='hidden' value = '".$audiencia->id_audiencia."'/></i></a></td>
                    </tr>";
