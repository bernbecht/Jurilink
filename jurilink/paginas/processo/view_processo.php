...
if ($_SESSION['tipo_usuario'] == 2) {
    ...
    require_once '../template/help/help-view-processo.php'; //texto do modal de ajuda
} else {
    include '../template/header_user.php'; //chama o header
    require_once '../template/help/help-view-processo-user.php'; //texto do modal de ajuda
}
