    ...
    function msgErroProcessoBD(data){
        if(data=="ERRADO AUTOR"){
            ...
            if(data_split[8]=='"num_unico"'){
                ...
                $a('<div class="alert alert-error fade in"><button type="button" class="close" data-dismiss="alert">x</button><p>'+data_split[2]+data+'</p></div>').appendTo('#msg_resultado_processo'); // appendTo é pra por em algum lugar
        }
    }
