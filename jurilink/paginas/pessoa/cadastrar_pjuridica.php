            ...
            <div class="row">
                ...
                <div class="span5" >
                    <div id="cnpj" class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="input-xlarge aviso cnpj_input" id="cnpj_input" name="cnpj" maxlength="14"/>                       
            ...
            <div class="row">
                ...
                <div class="span5" >
                    <div id="estado" class="control-group">
                        ...
                        <div class="controls">                    
                            <select  name="estado" id="estado_input" class="comboBox_small aviso">
...
<?php
    require_once '../template/help/help_cadastrar_juridica.php';
?>
