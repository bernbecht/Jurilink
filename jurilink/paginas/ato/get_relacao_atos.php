...
if (!$resultado) {
    ...
    echo "<div id='tabela'>";
    echo "<table = 'atos' class='table table-striped table-condensed-secundaria' >";
    echo "<thead>";
    echo "<tr>
                <th>Nome</th>
    ...
    do {
        ...
        if ($resultado->flag_cliente == 't')
            ...
            echo "<td class = 'centro'> NÃO </td>";
                ...
                <td class='centro'><a class='tooltip_class' rel='tooltip' data-placement='top' data-original-title='Editar ato' href='#'><i class='icon-pencil editar-ato'><input type='hidden' value = '" .$resultado->nome."|".$resultado->id_ato."|".$resultado->descricao."|".$resultado->previsao."|".$resultado->flag_cliente."'/></i></a></td>
                </tr>";
