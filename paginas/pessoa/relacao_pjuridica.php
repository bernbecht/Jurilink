 ...
 */
$chamar_funcao = getPessoas($conexao1, 1, $limite, $offset);

$pesq_juridica = $chamar_funcao[0]; //pega a posição 0 do array de retorno
...
$parcial = pg_num_rows($pesq_juridica);
//echo $parcial;
...
<div class="container content">
    ...
    <?php 
        ...
        do {
            echo "<tr>	
                <td><a href=view_pessoajuridica.php?id=$resultado->id_pessoa>" . $resultado->nome_pessoa . "</a></td>
...
<div class ="row">
        <div class = "span2 offset3">
            <?php
                if ($offset>0)
                    echo "<a class= btn btn-small href=relacao_pjuridica.php?offset=".($offset-$limite)."&limite=$limite>";
        ...
        <div class="span2">
        <form name="num_resultados" action="relacao_pjuridica.php" method="post">
        ...
        <?php
        if ($cont<$total)
         echo "<a class= btn btn-small href=relacao_pjuridica.php?offset=".($limite+$offset)."&limite=$limite&cont=".($cont+$parcial).">";
        else echo "<a class= btn btn-small disabled>";
       echo "Pr&oacute;ximo
